...
Jessop, S. A., Monk, J., & Friedman, A. (2026). sajessop/SQAPI: Initial Release (v1.0). Zenodo. https://doi.org/10.5281/zenodo.18462526\
...
See Vignette: Introduction to SQAPI, for more comprehensive examples and explanation.
```{r example}
if (interactive()) {
  library(SQAPI)
